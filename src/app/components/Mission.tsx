...
const MissionSection = () => {
    return (
        <section className='bg-[#f96618]'>
            <div className=" max-w-7xl mx-2.5 xl:mx-auto   py-12 md:py-16  ">
                ...
                <div className=" flex flex-col xl:flex-row justify-between items-start mb-8 lg:mb-0 lg:pr-8 gap-x-10">
                    <motion.h2
                        ...
                        className='text-3xl md:text-4xl xl:text-5xl flex-row font-bold flex gap-x-5 text-white items-center text-center w-full xl:w-2/6 justify-center'>
                        Our Mission
                    ...
                    <motion.p
                        ...
                        whileInView={{ y: 0, transition: { type: "linear", duration: 1.0 } }}
                        viewport={{ once: true, amount: 0.1 }}
                        className="text-white w-full xl:w-4/6 pt-5">
